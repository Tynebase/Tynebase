...
exports.default = aiApplySuggestionRoutes;
...
const ApplySuggestionRequestSchema = zod_1.z.object({
    document_id: zod_1.z.string().uuid('Invalid document ID format'),
    suggestion: zod_1.z.object({
        type: zod_1.z.enum(['grammar', 'clarity', 'structure', 'completeness', 'style']),
        title: zod_1.z.string().min(1, 'Suggestion title is required'),
        reason: zod_1.z.string().min(1, 'Suggestion reason is required'),
        original: zod_1.z.string().optional(),
        suggested: zod_1.z.string().optional(),
    }),
 ...
 */
async function aiApplySuggestionRoutes(fastify) {
    fastify.post('/api/ai/enhance/apply', {
        preHandler: [
        ...
        try {
            ...
            const creditsToDeduct = (0, creditCalculator_1.getModelCreditCost)('deepseek');
...
Generate improved content that addresses this suggestion. Return ONLY the generated content that should be added or replace the original text. Do not include explanations or formatting markers.`;
            ...
            const aiResponse = await (0, bedrock_1.generateText)({
                prompt,
                model: 'deepseek-v3',
                maxTokens: 1500,
                temperature: 0.5,
...
//# sourceMappingURL=ai-apply-suggestion.js.map