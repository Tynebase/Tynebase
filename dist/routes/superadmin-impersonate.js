...
exports.default = superAdminImpersonateRoutes;
 ...
 */
async function superAdminImpersonateRoutes(fastify) {
    /**
     ...
     */
    fastify.post('/api/superadmin/impersonate/:tenantId', {
        ...
        try {
            ...
            const { data: targetUsers, error: userError } = await supabase_1.supabaseAdmin
                .from('users')
            ...
            const { data: sessionData, error: sessionError } = await supabase_1.supabaseAdmin.auth.verifyOtp({
...
//# sourceMappingURL=superadmin-impersonate.js.map