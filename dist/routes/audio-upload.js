...
exports.default = audioUploadRoutes;
 ...
 */
async function audioUploadRoutes(fastify) {
    fastify.post('/api/ai/audio/upload', {
        preHandler: [
        ...
        try {
            ...
            const formData = {
                ...
                ai_model: formFields.ai_model || 'gemini',
            };
            ...
            let gcsUri;
            try {
                gcsUri = await (0, gcs_1.uploadBufferToGCS)(fileBuffer, gcsFileName, mimetype);
            }
            catch (uploadError) {
                request.log.error({
                    filename: sanitizedFilename,
