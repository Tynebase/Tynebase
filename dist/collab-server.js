 ...
 */
function insertTextWithMarks(parent, text) {
 ...
 */
function initializeYdocFromContent(ydoc, content) {
     ...
     */
    function hasUpcomingListItem(fromIndex, expectedIndent) {
 ...
 */
function convertYjsToMarkdown(state) {
    try {
         ...
         */
        const extractFormattedText = (textNode) => {
         ...
         */
        const extractMarkdown = (element, depth = 0) => {
            let markdown = '';
            try {
