...
function testHierarchicalPrefixes() {
    ...
    const chunks = (0, chunking_1.chunkMarkdownSemanticaly)(COMPLEX_MARKDOWN, 'Test Document');
    let passed = true;
...
function testChunkQuality() {
    ...
    for (const chunk of chunks) {
        ...
        if (chunk.metadata.tokenCount > chunking_1.CHUNKING_CONFIG.MAX_CHUNK_SIZE * 1.33) {
...
function testChunkingStats() {
    ...
    const chunks = (0, chunking_1.chunkMarkdownSemanticaly)(COMPLEX_MARKDOWN, 'Test Document');
    const stats = (0, chunking_1.getChunkingStats)(chunks);
