...
async function testDirectKey() {
    ...
    try {
        const client1 = new client_bedrock_runtime_1.BedrockRuntimeClient({
            region,
            credentials: {
                accessKeyId: apiKey,
    ...
    try {
        const client2 = new client_bedrock_runtime_1.BedrockRuntimeClient({
            region,
        });
        const payload = {
            anthropic_version: 'bedrock-2023-05-31',
...
testDirectKey();
//# sourceMappingURL=test-bedrock-direct.js.map