            ...
            <div className="mb-4 space-y-2">
              ...
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  ...
                  className="w-4 h-4 rounded border-[var(--border-default)] text-[var(--brand-primary)] focus:ring-[var(--brand-primary)]"
                />
                <span className="text-sm text-[var(--text-secondary)]">Generate summary (+{videoIngestionOptions.ai_model === 'claude' ? 2 : videoIngestionOptions.ai_model === 'gemini' ? 1 : 1} credits/video)</span>
              </label>
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  type="checkbox"
                  ...
                  className="w-4 h-4 rounded border-[var(--border-default)] text-[var(--brand-primary)] focus:ring-[var(--brand-primary)]"
                />
                <span className="text-sm text-[var(--text-secondary)]">Generate article (+{videoIngestionOptions.ai_model === 'claude' ? 2 : videoIngestionOptions.ai_model === 'gemini' ? 1 : 1} credits/video)</span>
              </label>
              ...
              <div className="pt-2">
                ...
                >
                  <option value="deepseek">DeepSeek (5 + 1/output credits)</option>
